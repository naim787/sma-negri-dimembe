...
<div class={`w-82 h-full bg-white flex justify-center items-start lg:static absolute left-0 md:translate transform transition-transform duration-300 ease-in-out ${Bars ? "translate-x-[-100%]" : "translate-x-[0%]"} `}>
